...
println("\nTo use with tADMM:")
println("  1. Update envs/tadmm/root_level/tadmm_socp.jl: systemName = \"flexparams_10k_1ph\"")
println("  2. Set T = 6 or T = 12 for initial testing")
println("  3. Run: JULIA_NUM_THREADS=16 julia envs/tadmm/root_level/tadmm_socp.jl")
println("="^60)

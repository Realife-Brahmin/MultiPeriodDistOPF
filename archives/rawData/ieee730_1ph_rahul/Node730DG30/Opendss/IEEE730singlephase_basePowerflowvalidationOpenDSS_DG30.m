...
DSSText.Command = 'New PVSystem.449 phases=1 bus1=449 kV=0.24 kVA=1.739 irradiance=1 Pmpp=1.449 kVAr = 0 %cutin=0.1 %cutout=0.1';
...
DSSText.Command = 'New PVSystem.672 phases=1 bus1=672 kV=0.24 kVA=3.098 irradiance=1 Pmpp=2.582 kVAr = 0 %cutin=0.1 %cutout=0.1';

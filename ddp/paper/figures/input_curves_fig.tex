...
% Styling follows the other input-profile figures in this study: same
...
%
% The curves are analytic shapes sampled at T
...
\begin{axis}[
    % The benchmark price runs 8.3-19.7 cents. The axis still tops out well above
...
per stage, taken directly; the curves show the underlying analytic profiles.
The $-0.8$~rad phase offset between

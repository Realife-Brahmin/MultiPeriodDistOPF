...
(right).  Markers are the data; the curves are the Lagrange
interpolants, which is what the solver actually evaluates.
Overshoot between nodes is slight ($1.0005$ against a node maximum of $0.999$),
but the interpolant degree is $T-1$.}

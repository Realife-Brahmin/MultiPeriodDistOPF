...
\addplot[ybar,bar width=20pt,draw=cChg!70!black,fill=cChg,fill opacity=0.75,
         line width=0.5pt,
...
\addplot[ybar,bar width=20pt,draw=cDis!70!black,fill=cDis,fill opacity=0.75,
         line width=0.5pt,
...
\addplot[cFilterDDP,dashed,line width=1.1pt,mark=square*,mark size=1.7pt]
  table[col sep=comma,x=tc,y=filter_action_kw]{figures/user_ddp_t3_optimal_battery_power.csv};
\addlegendentry{FilterDDP}
\addplot[black,line width=1.0pt,forget plot,domain=-0.3:3.3,samples=2]{0};
\addplot[cLim,densely dashed,line width=0.9pt,forget plot,domain=-0.3:3.3,samples=2]{450};
\addplot[cLim,densely dashed,line width=0.9pt,forget plot,domain=-0.3:3.3,samples=2]{-450};
\end{axis}
...
\addplot[ybar,bar width=20pt,draw=cB0!70!black,fill=cB0,fill opacity=0.85,
         line width=0.5pt] coordinates {(0,2000)};
\addlegendentry{Initial $B^0$}
\addplot[ybar,bar width=20pt,draw=cSOC!70!black,fill=cSOC,fill opacity=0.75,
...
\addplot[cFilterDDP,dashed,line width=1.0pt,mark=square*,mark size=1.5pt]
  table[col sep=comma,x=t,y=filterddp_kwh]{figures/user_ddp_t3_optimal_battery.csv};
\addlegendentry{FilterDDP}
\addplot[cLim,densely dashed,line width=0.9pt,forget plot,domain=-0.3:3.3,samples=2]{1950};
\addplot[cLim,densely dashed,line width=0.9pt,forget plot,domain=-0.3:3.3,samples=2]{1200};
\end{axis}
\end{tikzpicture}
\end{minipage}

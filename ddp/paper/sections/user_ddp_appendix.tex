...
As a separate stabilization check on the shared $T=6$ instance, averaging each
new raw dual vector with the preceding two also failed to converge, settling
instead into a smaller period-four cycle through 2000 sweeps.

...
## Exact diagonal-Hessian implementation rewrites (2026-09-20)

Direct diagonal curvature construction, one-shot triplet assembly of the SOCP
second derivatives, and fixed-pattern KKT storage preserve the complete tested
iteration trajectories. Combined, they reduce matched IEEE2522 `T=24` time to
near optimality from `755.189 s` to `591.613 s` (21.66%). The corresponding
large10k `T=6` run completed at iteration 103 in `2330.671 s`; no exact
pre-rewrite baseline exists for that matched instance. See

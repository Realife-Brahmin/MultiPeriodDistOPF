...
\subsection{Adaptive Penalty Parameter: Two-Phase Strategy with Watchdog}
...
\subsubsection{Residual Calculations (Exact Implementation)}
...
\subsubsection{Phase 1: Aggressive Primal Convergence (Until $\|r\| \leq \epsilon_{\text{pri}}$)}
...
\subsubsection{Phase 2: Bidirectional Adaptation (After primal convergence)}
...
\subsubsection{Primal Residual Watchdog (All Phases)}
...
\subsubsection{Dual Variable Rescaling}
...
\subsubsection{Complete Parameter Summary}
...
\subsubsection{Convergence Impact}

function  opf_model_initialization_pf_int(nBus,nNcurt_gen,rdata_buses)
...
function opf_model_objective_pf_int(acpf,nSc,nTP,nNcurt_gen,prob_scs,time_step,stoch_model,Pg,Qg)
...
################################################################################
function network_constraints_no_function_new_pf_int(acpf,node_data,nw_buses,nw_lines,nBus,nLines,nNcurt_gen,rdata_buses,vbase,Ibase,Pg,Qg,e,f,pg_min,pg_max,qg_min,qg_max,yij_line,dLines,i_ncurt_gens,nSc,nTP)
################################################################################
...
############################ Solve OPF Model ###################################
################################################################################
function opf_model_solve_pf_int(acpf,error_msg)
...
################################################################################
function opf_model_solution_pf_int(term_status,e,f,Pg,Qg,nNcurt_gen,pgen_tol,qgen_tol,nTP,nSc,nBus,sbase)

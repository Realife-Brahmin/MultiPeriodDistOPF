#!/usr/bin/env julia
# Build a 2x3 composite of the 5 ieee2522C_1ph T=24 rho-sweep convergence PNGs.
# Output: pngs_review/ieee2522C_1ph/T024_rho_sweep_composite.png

using FileIO, Images, Plots
Plots.default(fontfamily = "Computer Modern")

const REVIEW_DIR = joinpath(@__DIR__, "pngs_review", "ieee2522C_1ph")
...
fig = plot(panels...; layout = (2, 3), size = (1650, 1500), dpi = 150,
           plot_title = "ieee2522C  T=24  rho sweep (eps_pri=1e-4, eps_dual=5e-4)",

...
#     println(filepath)
#     # Initialize vectors for hours and prices
#     hours = Int[]
#     prices = Float64[]

#     # Read the LoadShapePSubsCost.dss file
...
#                 continue
#             end
#             # Parse the hours and prices from the file
#             tokens = split(line)
#             if length(tokens) == 2
#                 push!(hours, parse(Int, tokens[1]))
#                 push!(prices, parse(Float64, tokens[2]))
#             end
#         end
#     end
